              ...
              {activeTab === 'overview' && (
                <div className="bg-white rounded-xl shadow-md p-6 mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <h3 className="text-lg font-semibold text-gray-800 mb-3">Plot Sizes & Pricing</h3>
                      <ul className="space-y-2">
                        {farm.plotSizes.map((size, index) => (
                          <li key={index} className="flex justify-between">
                            <span className="text-gray-600">{size}:</span>
                            <span className="font-medium">
                              ₹{((farm.startingPrice * (1 + index * 0.5)) / 100000).toFixed(1)}L onwards
                            </span>
                          </li>
                        ))}
                      </ul>
                  ...
                  <div className="mb-6">
                    <h3 className="text-lg font-semibold text-gray-800 mb-3">Crop Types</h3>
